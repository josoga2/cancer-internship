...
const ImageGenerator = () => {
  ...
  const [program] = useState('Building AI Agents for Biology');
  ...
  const [announcement] = useState('I am excited to announce that I got into the HackBio Building AI Agents for Biology Internship 🎉');
  const [hashtag] = useState('#HackBioAIAgents26');
