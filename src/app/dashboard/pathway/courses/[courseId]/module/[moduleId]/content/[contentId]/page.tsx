...
return (
                        ...
                        <div className="w-full flex flex-row gap-10">
                            <div className="border-2 rounded-md border-hb-green prose prose-base p-5 flex flex-col  w-full">
                                <p className="font-bold text-lg">
                                    Project Details: Submit code solution to the project below
                                </p>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <textarea id="solution" value={solution} onChange={(e) => setSolution(e.target.value)} placeholder="type your solution..." required  className='bg-green-950 text-white text-xs placeholder:text-xs p-3 h-[400px] font-mono border border-neutral-200'/>
    ...
    <div className="md:hidden w-full flex flex-col pb-20 min-h-[100svh] ">
            ...
            <div className="flex flex-col p-5 text-sm gap-3 ">
                <a href={`/dashboard/pathway/courses/${courseId}`} className="flex items-center gap-2 font-bold text-xl hover:underline"> <CiViewList className="text-3xl font-bold" /> Table of Content</a>
            </div>
            ...
            <div className="flex flex-col gap-5 px-4  bg-green-50 py-10 w-full pb-20 ">
                {filteredContentList.length > 0 ? filteredContentList.map((content) => (
                    <div key={content.id} className="flex flex-col gap-5  scroll-pb-20 overflow-auto">
                        ...
                        {content.content_type === 'codeTask' && (
                            <div className="w-full flex flex-col text-sm">
                                <div className="border-2 rounded-md border-hb-green p-2 flex flex-col w-full prose py-5">
                                    <Markdown
                                        remarkPlugins={[
                                            remarkGfm,
                                            remarkMath,
