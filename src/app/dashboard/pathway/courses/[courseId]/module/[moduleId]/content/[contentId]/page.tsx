...
function Page() {
  ...
  const buildContentHref = (targetModuleId: number, targetContentId: number) =>
    `/dashboard/pathway/courses/${courseId}/module/${targetModuleId}/content/${targetContentId}?type=single`;

  const nextHref = nextContentInModuleId > 0
    ? buildContentHref(moduleId, nextContentInModuleId)
    : `/dashboard/pathway/courses/${courseId}?type=single`;
      ...
      <div className="w-full rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Did you feel a clear sense of progress and growth throughout the pathway?</p>
            {renderOptions(
            ...
            {subscriptionIntStatus ? (
                  ...
                  <div className="w-full grid grid-cols-2 gap-6">
                      ...
                      <form className="space-y-4 pt-4" onSubmit={(e) => { e.preventDefault(); }}>
                        ...
                        <div className="grid gap-2">
                          <Label htmlFor="cert-skill" className="text-sm">
                            What was the most valuable skill or concept you gained during this pathway?
                          </Label>
                          <Input
                            id="cert-skill"
                            type="text"
                        ...
                        <div className="grid gap-2">
                          <Label htmlFor="cert-improve" className="text-sm">
                            If you could improve one thing about the pathway experience, what would it be?
                          </Label>
                          <textarea
                            id="cert-improve"
                            required
                        ...
                        <div className="text-sm text-gray-700">
                          ...
                          <p>Your Total Pathway Grade: <span className="font-semibold">{(Math.min(Math.ceil((Number(userXP) / Number(totalXP)) * 120), 100))}%</span></p>
                        </div>
                        {cert ? (
                    ...
                    <div className="rounded-lg border border-green-200 bg-white p-6 shadow-sm">
                      ...
                      <ul className="pt-3 text-sm text-gray-700 list-disc pl-5 space-y-2">
                        ...
                        <li>Your pathway grade (percentage) will be recorded on your certificate.</li>
              ...
              <div>
                <p className="mb-10 text-sm text-red-600">
                  {subscriptionIntStatus ? "" : (
                    <span>
                      <p>"Your subscription to this pathway has expired." <Link className="font-bold hover:underline" href={`/dashboard/checkout?prog=course&id=${courseId}`}> Click here to subscribe Now</Link> </p>
                    </span>
                  )}
                </p>
              </div>
        ...
        <div className="flex-1 px-4 pb-28">
          ...
          {activeTab === "resources" && (
            <div className="rounded-lg border border-gray-200 bg-white p-4 text-sm text-gray-700">
              ...
              <div className="pt-3">
                <TocLink tocHref={`/dashboard/pathway/courses/${courseId}`} />
              </div>
            </div>
          )}
        </div>
