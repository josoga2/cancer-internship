                  ...
                  <table className="min-w-[1120px] text-left text-sm">
                    <thead>
                      <tr className="border-b border-slate-300 dark:border-slate-700">
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">Compound Name</th>
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">Class</th>
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">SMILES</th>
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">PubChem</th>
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">InChIKey</th>
                        <th className="px-2 py-2 font-semibold text-slate-700 dark:text-slate-200">MW</th>
                    ...
                    <tbody>
                      {phytochemicals.map((compound) => (
                        <tr key={compound.id} className="border-b border-slate-200 align-top dark:border-slate-800">
                          <td className="px-2 py-3 font-semibold text-slate-800 dark:text-slate-100">{compound.compound_name || "-"}</td>
                          <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{compound.compound_class || "-"}</td>
                          <td className="max-w-[260px] px-2 py-3 font-mono text-xs text-slate-600 dark:text-slate-300">
                            <span className="line-clamp-2 break-all">{compound.smiles || "-"}</span>
                          </td>
                          <td className="px-2 py-3">
                            {compound.pubchem_cid ? (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex rounded-md border border-blue-500 px-3 py-1 text-xs font-semibold text-blue-600 hover:bg-blue-50 dark:border-blue-400 dark:text-blue-300 dark:hover:bg-blue-500/10"
                              >
                                View
                              </a>
                            ) : (
                          ...
                          <td className="max-w-[220px] px-2 py-3 font-mono text-xs text-slate-600 dark:text-slate-300">
                            <span className="line-clamp-2 break-all">{compound.inchikey || "-"}</span>
                          </td>
                          <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{formatMetric(compound.molecular_weight)}</td>
                          <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{formatMetric(compound.logp)}</td>
                          <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{formatMetric(compound.h_donors)}</td>
                          <td className="px-2 py-3 text-slate-600 dark:text-slate-300">{formatMetric(compound.h_acceptors)}</td>
                          <td className="px-2 py-3">
                            <span
                            ...
                            >
                              {compound.lipinski_pass === null ? "N/A" : compound.lipinski_pass ? "PASS" : "FAIL"}
                            </span>
                          </td>
                        </tr>
                      ))}
