        ...
        <main>
            ...
            <div className="flex flex-col w-full md:hidden p-2  rounded-xl">
                <div className="w-full text-start items-center">
                    <p className="w-full pb-10 text-2xl font-bold">Learning Tracks</p>
                    <div className="grid grid-cols-1 gap-2 items-start justify-center w-full ">
                        <div className=" flex flex-col w-56 p-2 justify-start items-start gap-5 min-h-24 border-2 border-hb-green rounded-md ">
                            <Image src={microbe.src} alt="microbe" width={50} height={50} />
                            <p className="font-bold">Microbes and Viruses</p>
                        </div>
                        <div className=" flex flex-col w-56 p-2 justify-start items-start gap-5 min-h-24 border-2 border-hb-green rounded-md ">
