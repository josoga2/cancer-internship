...
export default function Hero() {
    ...
    return (
        <section
            className="relative left-1/2 min-h-[560px] w-screen -translate-x-1/2 overflow-hidden bg-hb-lightgreen bg-cover bg-center dark:bg-[#0f172a] md:min-h-[680px] md:bg-[center_right]"
        ...
        >
            ...
            <div className="relative mx-auto flex min-h-[560px] w-full max-w-5xl items-center px-5 py-24 md:min-h-[680px] md:px-0">
