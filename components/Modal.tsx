...
export default function Modal(){
    ...
    return(
        ...
        <main>
            ...
            <section className="hidden md:flex md:max-w-screen-lg md:m-auto md:items-center md:justify-between  pt-10 px-10 relative">
            {modal &&    
                            ...
                            <div className="flex flex-col gap-4 pt-5">
                                <div className="p-4 border-2 border-hbblue-1 rounded-md">
                                    ...
                                    <div className="flex flex-col  gap-3 pt-5">
                                        <Link href={''}> <span className="text-xs flex flex-row gap-2 items-center"> <FaArrowRight /> Register with <FaCcStripe className="text-xl" /> </span> </Link>
                                        <Link href={''}> <span className="text-xs flex flex-row gap-2 items-center"> <FaArrowRight /> Register with <PiButterflyBold className="text-xl" /> (Works well in Africa)</span> </Link>
                                    </div>
                                </div>
