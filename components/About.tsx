            ...
            <section className="hidden md:flex md:max-w-screen-lg md:m-auto md:items-center md:justify-between  pt-10 px-10">
                <div className="text-2xl">
                    ...
                    <div className="w-full flex items-center flex-row gap-10 justify-center py-10"> 
                        ...
                        <div className="hidden md:flex font-semibold rounded-md border-4 border-hbblue-3 text-white hover:bg-white bg-hbblue-3 hover:text-hbblue-3 w-fit  text-center py-2 text-base px-5"> <a href='?modal=true'> <span className="flex flex-row gap-2"> <p className="line-through"></p> <p>$30 Premium</p></span>  <p>Apply Now!</p> </a> </div>
                    </div>
                </div>
            </section>
