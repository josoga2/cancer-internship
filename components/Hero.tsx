                ...
                <div className="grid grid-cols-2 items-center ">
                    ...
                    <div className="">
                        <div className="flex flex-col gap-5">
                            ...
                            <span className="text-black text-lg py-5">The fastest way to become an expert in Bioinformatics and Biomedical Data Analysis <p className="font-bold text-2xl text-orange-500 underline underline-offset-2 decoration-4 py-2">8 weeks </p></span>
